              ...
              {[
                ...
                >
                  ...
                  <motion.div 
                    ...
                    style={{ '--pulse-color': item.color === 'emerald' ? '16, 185, 129' : item.color === 'blue' ? '59, 130, 246' : item.color === 'indigo' ? '99, 102, 241' : item.color === 'amber' ? '245, 158, 11' : '100, 116, 139' } as any}
